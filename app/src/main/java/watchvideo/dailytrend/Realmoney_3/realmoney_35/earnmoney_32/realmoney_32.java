...
public class realmoney_32 {
    ...
    @Expose
    private List<realmoney_34> related = null;
    ...
    public void setVCounteView(Integer num) {
        this.viewcounter = num;
    }

    public List<realmoney_34> getRelated() {
        return this.related;
    }

    public void setRelated(List<realmoney_34> list) {
        this.related = list;
    }
}
